        ...
        <?php
            ...
            while ($linha = mysqli_fetch_assoc($resultado)) {
                ...
                <tr>
                    ...
                    <td>
                        <a href="./salvar-produtos.php?id='.$linha['Nome'].'" class="btn btn-edit">Editar</a>
                        <a href="./action/produtos.php?acao=excluir&id='.$linha['ID'].'" class="btn btn-delete">Excluir</a>
                    </td>
                  </tr>';
            }
            ?>
